  ...
  return (
    <div>
      ...
      <div className={cx(styles.topScroll, styles.transition, styles.fixed)}>
        <a href="#banner" className={styles.scrollTo}>
          <ExpandLessIcon />
        </a>
      </div>
      {/* Top scroll End */}
          ...
          <div className={cx(styles.row, styles.flexAlign)}>
            ...
            <div className={cx(styles.collg8, styles.colmd9, styles.textRight)}>
              <div
                onClick={(e) => {
                  e.preventDefault();
                  state2 === 1 ? toggleState2(2) : toggleState2(1);
                }}
                className={
                  state2 === 2
                    ? cx(styles.menuToggle, styles.active)
                    : styles.menuToggle
                }
              >
                {state2 === 1 ? (
              ...
              <div
                style={{ display: state2 === 2 ? "block" : null }}
                className={styles.menu}
              >
                <div className={cx(styles.signin, styles.dInlineBlock)}>
                  <Link2 href="/api/logout">
